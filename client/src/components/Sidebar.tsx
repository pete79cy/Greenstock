...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  useEffect(() => {
    ...
    if (location === "/py8-purchases" || location === "/py8-batch-purchases" || location === "/py8-report" || location === "/py9-sales" || location === "/plant-varieties") {
        ...
        <ul className="space-y-2">
          ...
          <li>
            <div 
              className={cn(
                "flex items-center p-2 rounded-md cursor-pointer",
                (location === "/py8-purchases" || location === "/py8-batch-purchases" || location === "/py8-report" || location === "/py9-sales" || location === "/plant-varieties") 
                  ? "bg-primary bg-opacity-10 text-primary" 
                  : "hover:bg-gray-100"
              )}
